...
{
  "title": "Podejrzane pytania",
  "text": "Po obejrzeniu filmu dokumentalnego o fałszywych alarmach bombowych zaczynasz szukać w Internecie odpowiedzi na pytanie, dlaczego nie wszystkich sprawców udaje się wykryć, oraz informacji o używanych przez nich metodach ukrywania tożsamości. Twoja ciekawość nie pozostaje niezauważona. Służby zaczynają się Tobą interesować i zbierać informacje na Twój temat.",
  "img": "podejrzane.png",
  "critical": false,
  "skill": [0,5],
},
{
  "title": "Fejkowe wideo z Twoim wizerunkiem",
  "text": "Do sieci wycieka wideo, na którym widać Twoją twarz podczas zamieszek po przegranym meczu. Jesteś jednym z napastników, którzy biją kibiców konkurencyjnego klubu. Przychodzi do Ciebie policja, aby Cię aresztować.",
